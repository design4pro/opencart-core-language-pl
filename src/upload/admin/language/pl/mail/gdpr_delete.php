...
// Text
$_['text_subject']   = '%s - Żądanie RODO zostało przetworzone!';
$_['text_request']   = 'Prośba o usunięcie konta';
$_['text_hello']     = 'Witaj <strong>%s</strong>,';
$_['text_user']      = 'Użytkownik';
$_['text_delete']    = 'Twoja prośba o usunięcie danych RODO została zakończona.';
$_['text_contact']   = 'Aby uzyskać więcej informacji, skontaktuj się z właścicielem sklepu tutaj:';
