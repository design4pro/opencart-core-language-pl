...
// Text
$_['text_subject'] = '%s - Wniosek RODO zatwierdzony!';
$_['text_request'] = 'Prośba o usunięcie konta';
$_['text_hello']   = 'Witaj <strong>%s</strong>,';
$_['text_user']    = 'Użytkownik';
$_['text_gdpr']    = 'Twoja prośba o usunięcie danych RODO została zatwierdzona i zostanie usunięta za <strong>%s dni</strong>.';
$_['text_q']       = 'Q. Dlaczego nie usuwamy od razu Twoich danych?';
$_['text_a']       = 'A. Żądania usunięcia konta będą przetwarzane po <strong>%s dniach</strong>, aby możliwe było przetworzenie wszelkich zwrotów, obciążeń zwrotnych lub wykrycia oszustw.';
$_['text_delete']  = 'Otrzymasz wiadomość e-mail z informacją o usunięciu konta.';
