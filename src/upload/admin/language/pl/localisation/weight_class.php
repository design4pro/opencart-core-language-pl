...
// Heading
$_['heading_title']    = 'Jednostki wagi';

// Text
$_['text_success']     = 'Sukces: Zmodyfikowano jednostki wagi!';
$_['text_list']        = 'Lista miar wagi';
$_['text_add']         = 'Dodaj jednostkę wagi';
$_['text_edit']        = 'Edytuj jednostkę wagi';

// Column
$_['column_title']     = 'Nazwa jednostki wagi';
$_['column_unit']      = 'Jednostka wagi';
$_['column_value']     = 'Wartość';
$_['column_action']    = 'Akcje';

// Entry
$_['entry_title']      = 'Nazwa jednostki wagi';
$_['entry_unit']       = 'Jednostka wagi';
$_['entry_value']      = 'Wartość';

// Help
$_['help_value']       = 'Ustaw 1.00000 jeżeli to jest domyślna jednostka wagi.';

// Error
$_['error_permission'] = 'Ostrzeżenie: Nie masz uprawnień do modyfikowania jednostek wagi!';
$_['error_title']      = 'Tytuł jednostki wagi musi zawierać od 3 do 32 znaków!';
$_['error_unit']       = 'Jednostka wagi musi zawierać od 1 do 4 znaków!';
$_['error_default']    = 'Ostrzeżenie: Nie można usunąć tej jednostki wagi, ponieważ jest obecnie ustawiona jako domyślna!';
$_['error_product']    = 'Ostrzeżenie: Nie można usunąć tej jednostki wagi, ponieważ jest obecnie przypisana do %s produktów!';
