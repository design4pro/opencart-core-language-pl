...
// Heading
$_['heading_title']    = 'Statusy stanów magazynowych';
...
$_['error_name']       = 'Nazwa statusu stanów magazynowych musi zawierać od 3 do 32 znaków!';
$_['error_product']    = 'Ostrzeżenie: Nie można usunąć tego statusu stanów magazynowych, ponieważ jest obecnie przypisany do %s produktów!';
